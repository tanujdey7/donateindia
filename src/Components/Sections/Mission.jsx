    ...
    return (
        <div className="mission-row row">
            <div className="mission-col cloud-icon-col-one col-2">
                <h1 className="cloud-icon-one"><BsCloud className="cloud" size={200} /></h1>
            ...
            <div className="mission-col col-4">
                <div className="mission-card card">
                    ...
                    <div className="mission-card-body card-body">
                        <h1 className="mission-text">The mission and goals of our organization</h1>
                        <h6 className="">Charity is the global movement encouraging the power of people and organization to transform their communities and the world. What can we do to make some changes?</h6>
                    </div></div>
            ...
            <div className="mission-col cloud-icon-col-two col-2">
                <h1 className="cloud-icon "><BsCloud size={200} /></h1></div>
        </div>
    )
}
